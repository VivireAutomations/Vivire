(function () {
  ...
  styleEl.textContent = [
    ...
    '@media(max-width:480px){#vivi-window{width:calc(100vw - 20px);left:10px;bottom:76px;}#vivi-pill{left:10px;bottom:10px;}}'
  ].join('');
